...
//123
            ...
            if (typeOfMsg === "media_message") {
              ...
              const options = {
                headers: {
                  Authorization:
                    "Bearer EAAIxByrVcvEBAItWXyJSxZCXRZCvc2SQAwinCNT8pzLHItZBGmPqctd5MKpzd0LqZCNtk0U5FySjJjdzyntYgDaLhQaBi8qM3pZAzq8c3bvXGoUZAx3rnTwB4CJyZCQPZBSqpjfhT894Di6Musy9ZBTwrH1qWmGw3OIJghZCOUTrpr6JF9DbDW0ZAKf",
                },
              };
                ...
                response.on("end", function () {
                  ...
                  const fetchImage = async (
                    ...
                    var config = {
                      ...
                      headers: {
                        Authorization:
                          "Bearer EAAKquLbpV04BACCyqZCdX0Bn73iPCGpMsKWujHJrTv0XZAbWiL76J0LFhhS68B826Hq9kPileGhcZBgBPrdaO4ylAFYvUVjrGuhA2Dr368vkdwwajS6UzUU7hjM4vQxiAt7QUVWpkboZCVPQNn7cO5kkRuYNYSaU01MUJAhhzu3Jltow7AsD",
                      },
                      data: data,
                    };
                    axios({
  ...
  Whatsapp.sendText({
    ...
    .catch(function (error) {
      ...
      sessionInfo: [],
        ...
        //             'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9..u0bxTwD-id2pLwW72D-wLkXQkm-ZSzY0DSJY8FaVBaE', 
        //             'Content-Type': 'application/json'
        //           },
        //           data : datamissing
        //         };
